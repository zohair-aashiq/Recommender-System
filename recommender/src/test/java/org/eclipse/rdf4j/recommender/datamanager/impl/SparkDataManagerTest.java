...
public class SparkDataManagerTest {
     ...
     */
    @Test
    public void testNBInInvListsStorage() {
        ...
        SailRecommenderRepository recRepository 
                = TestRepositoryInstantiator.createBookUbCfRecAndPreprocess( 
                        RecStorage.SPARK, neighborhoodSize, numberOfTopRatings);

        CfSparkStorage storage = (CfSparkStorage)
     ...
     */
    @Test
    public void testNBInInvListsStorage2() {
     ...
     */
    @Test
    public void testGetRatingAverageOfUser() throws RecommenderException {
